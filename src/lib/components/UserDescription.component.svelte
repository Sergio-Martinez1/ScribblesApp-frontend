...
{#if loading}
	<div class="w-full h-fit bg-lavandaGray dark:bg-purpleGray rounded-2xl p-3.5">
		<div class="animate-pulse flex space-x-4">
			<div class="flex-1 space-y-6 py-1">
				<div class="h-2 bg-lavandaLight dark:bg-purpleLight rounded" />
				<div class="space-y-3">
					<div class="grid grid-cols-3 gap-4">
						<div class="h-2 bg-lavandaLight dark:bg-purpleLight rounded col-span-2" />
						<div class="h-2 bg-lavandaLight dark:bg-purpleLight rounded col-span-1" />
					</div>
					<div class="h-2 bg-lavandaLight dark:bg-purpleLight rounded" />
				</div>
			</div>
		...
		<div class="flex gap-x-5 flex-wrap opacity-70">
			{#if webSite}
				<div class="flex gap-1.5 items-center w-fit">
					<div>
						<Link width={14} height={14} tailwindStrokeClass={'stroke-black dark:stroke-white'} />
					</div>
					<a
			...
			{#if birthDay}
				<div class="flex gap-1.5 items-center w-fit">
					<div>
						<Gift width={16} height={16} tailwindStrokeClass={'stroke-black dark:stroke-white'} />
					</div>
			...
			{#if location}
				<div class="flex gap-1 items-center w-fit">
					<div>
						<MapPin width={14} height={14} tailwindStrokeClass={'stroke-black dark:stroke-white'} />
					</div>
					<p class="dark:text-white">
						{location}
					</p>
