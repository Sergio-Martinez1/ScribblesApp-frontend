<script lang="ts">
	...
	export let post_id: number | undefined = -1;
...
<div
	class="bg-lavandaGray dark:bg-purpleGray flex px-2 relative py-2 w-full justify-around shadow-lavandaLight dark:shadow-purpleLight shadow-[0px_0px_0px_2px_rgba(0,0,0,0.3)]"
>
	...
	{#if tag_toogle}
		<div
			...
			class="absolute max-sm:bottom-10 sm:top-9 right-2 z-10"
		>
