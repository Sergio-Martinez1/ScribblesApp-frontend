  ...
  {#if loading}
    <div class="animate-pulse flex flex-col p-4">
      <div class="flex gap-4 mb-3">
        <div class="rounded-full bg-purpleLight h-[59px] w-[59px]"></div>
        <div class="flex-1">
          <div class="grid grid-cols-10 gap-4 h-[59px] items-center">
            <div class="h-6 bg-purpleLight rounded-xl col-span-2"></div>
            <div class="h-6 bg-purpleLight rounded-xl col-span-1"></div>
          </div>
        </div>
      </div>
      <div class="w-full h-32 bg-purpleLight rounded-2xl"></div>
    </div>
  {:else}
